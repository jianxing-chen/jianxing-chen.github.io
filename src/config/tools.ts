...
export const LOCATION_PRESETS: ToolLocationPreset[] = [
  { name: { en: 'Beijing', zh: '北京' }, lat: 39.9, lng: 116.4, timer7: { lat: 39.96, lng: 116.36 } },
  { name: { en: 'Shanghai', zh: '上海' }, lat: 31.23, lng: 121.47, timer7: { lat: 31.23, lng: 121.47 } },
  { name: { en: 'Tokyo', zh: '东京' }, lat: 35.68, lng: 139.69, timer7: { lat: 35.68, lng: 139.69 } },
  { name: { en: 'Sydney', zh: '悉尼' }, lat: -33.87, lng: 151.21, timer7: { lat: -33.87, lng: 151.21 } },
  { name: { en: 'London', zh: '伦敦' }, lat: 51.51, lng: -0.13, timer7: { lat: 51.51, lng: -0.13 } },
  { name: { en: 'New York', zh: '纽约' }, lat: 40.71, lng: -74.01, timer7: { lat: 40.71, lng: -74.01 } },
  { name: { en: 'La Palma', zh: '拉帕尔马' }, lat: 28.76, lng: -17.89, timer7: { lat: 28.76, lng: -17.89 } },
  { name: { en: 'Mauna Kea', zh: '莫纳克亚' }, lat: 19.82, lng: -155.68, timer7: { lat: 19.82, lng: -155.68 } },
];
